...
import UserOne from "../assets/profile.png";

const DropdownUser = ({image}) => {
  ...
  return (
    <div className="relative">
      ...
      <div
        ...
        className={`shadow-default absolute right-0 mt-4 flex w-60 flex-col rounded-sm border border-gray-200 bg-white ${
          dropdownOpen === true ? "block" : "hidden"
        }`}
      >
        <ul className="flex flex-col gap-5 border-b border-gray-200 px-6 py-7">
          <li>
            <Link
              to="/profile"
