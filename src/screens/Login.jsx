...
const Login = () => {
  ...
  return (
    <div className="flex h-screen w-full flex-row flex-wrap">
      {/* Side View */}
      <div className="order-2 flex w-full flex-col items-center justify-center bg-sidebar py-14 sm:w-[40%] md:order-1 md:w-[30%] md:shadow-md">
        <h1 className="text-[35px] font-bold text-heading">Welcome Back!</h1>
        <p className="mt-[5px] text-[15px] font-normal text-[#6C7278]">
          Login to continue{" "}
        </p>

        {/* Email */}
        <div className="mt-[90px] flex w-full justify-center px-[40px]">
          <input
            type="email"
        ...
        <div className="mt-[8px] w-full flex flex-row px-[40px]">
          <div
            onClick={() => setChecked(!checked)}
            className=" flex w-1/2 cursor-pointer select-none flex-row items-center gap-x-2 "
          >
            <div className="h-[17px] w-[17px] rounded-[4px] border-[2px] border-text">
              {checked && (
                <div className="flex h-full w-full items-center justify-center bg-text">
                  <svg
                    width="13"
                    height="8"
                    viewBox="0 0 13 8"
        ...
        <div className="mt-[30px] flex w-full flex-col items-center justify-center px-[40px]">
          ...
          <p className="mt-4 cursor-pointer" onClick={() => navigate("/register")}>
